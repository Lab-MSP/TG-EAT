...
parser.add_argument("--data_path", type=str, default="/media/kyunster/ssd1/corpus/MSP-Podcast/1.10")
...
audio_path = "/media/kyunster/ssd1/corpus/MSP-Podcast/1.10/enhanced/FRCRN/"
...
for dtype in ["test"]:
    ...
    cur_wavs = utils.load_random_snr_audio(audio_path, cur_utts)
...
# ssl_model.feature_extractor = ssl_feat_model.feature_extractor
