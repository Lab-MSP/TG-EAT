...
for dtype in ["test"]:
    ...
    ############
    # Add noise #
    noisy_wavs, raw_noise_type_list = utils.make_noisy_test_wavs(cur_utts, cur_wavs, noise_pair_path, snr=args.snr)
    ############
    ...
    noise_type_list=["clean condition"]*len(raw_noise_type_list)
    # noise_type_list=raw_noise_type_list
...
if args.ssl_type == "wavlm-large":
    feat_dim = 1024
elif args.ssl_type in ["wavlm-base", "wavlm-base-plus"]:
    feat_dim = 768
