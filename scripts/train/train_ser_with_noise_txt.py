...
for dtype in ["train", "dev"]:
    ...
    noise_vec_set = utils.NoiseCLAPSet(noise_type_list, noise_vec_dir=noise_vec_dir, miss_ratio=args.miss_ratio)
    ...
    noise_dataset = utils.CombinedSet([noise_wav_set, noise_vec_set])
